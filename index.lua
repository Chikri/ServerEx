...
if orig == true then gg.alert('Hook Detected') os.exit() end

t = gg.choice({'Check For Update', 'Check Changelog', 'Continue To Script'})
    if t == 1 then foh() end
    if t == 2 then changebruh() end
    if t == 3 then gheyhang() end
